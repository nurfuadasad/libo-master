...
class Image_Control_Item extends Widget_Base

{
...

    {
        ...
        return 'libo-image-control-item-widget';
...

    {
        ...
        return esc_html__('Image Control Item', 'libo-master');
...

    {
        ...
        <div class="image-control-area">
            <div class="content">
                <div class="bg-img" style="background-image: url(<?php echo esc_url($image_url) ?>)">  </div>
                <div class="icon">
                    <?php echo libo_master()->render_elementor_icons($settings['icon']) ?>
                </div>
            </div>
            <div class="content style-01">
                <div class="bg-img" style="background-image: url(<?php echo esc_url($image_url_02) ?>">   </div>
                <div class="icon style-01">
                    <?php echo libo_master()->render_elementor_icons($settings['icon_02']) ?>
                </div>
            </div>
        </div>
...
Plugin::instance()->widgets_manager->register_widget_type(new Image_Control_Item());