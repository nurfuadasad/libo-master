...
namespace Elementor;
class Libo_Brand_Carousel_One_Widget extends Widget_Base
{
    ...
    {
        return 'libo-brand-carousel-one-widget';
    }
    ...
    {
        return esc_html__('Brand Carousel One', 'libo-master');
    }
    ...
    {
        return ['Brand', 'Sponsor', 'Clint', "Ir Tech", 'Libo'];
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control('screenshort_items', [
            'label' => esc_html__('Brand Slider Item', 'libo-master'),
...
Plugin::instance()->widgets_manager->register_widget_type(new Libo_Brand_Carousel_One_Widget());
