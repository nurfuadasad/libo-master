...
namespace Elementor;
class Libo_Service_Slider_Two_Widget extends Widget_Base
{
    ...
    {
        return 'libo-service-slider-two-widget';
    }
    ...
    {
        return esc_html__('Service: Item 02', 'libo-master');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control('icon_color', [
            ...
            'selectors' => [
                "{{WRAPPER}} .service-single-item-02 .icon" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('content_bg_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-02 .content-wrap" => "background-color: {{VALUE}}"
            ]
        ]);
        $this->add_control('title_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-02 .content .title" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('paragraph_typography', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-02 .content p" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('read_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-02 .content-wrap .read-btn" => "color: {{VALUE}}"
            ]
        ]);
        ...
        $this->add_control('icon_hover_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-02:hover .icon" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('content_hover_bg_color', [
            'label' => esc_html__('Content Background Color', 'libo-master'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-02:hover .content-wrap" => "background-color: {{VALUE}}"
            ]
        ]);
        $this->add_control('title_hover_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-02:hover .content .title" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('paragraph_hover_typography', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-02:hover .content p" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('read_hover_bg_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-02 .content-wrap .read-btn:hover" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .service-single-item-03:hover',
            ]
        );
        $this->end_controls_tab();
            ...
            <div class="row">
                ...
                while ($post_data->have_posts()):$post_data->the_post();
                    ...
                    <div class="col-lg-<?php echo esc_attr($settings['column']); ?> col-md-6">
                        <div class="service-single-item-02 margin-bottom-30">
...
Plugin::instance()->widgets_manager->register_widget_type(new Libo_Service_Slider_Two_Widget());