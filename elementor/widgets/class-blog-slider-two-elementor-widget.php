...
namespace Elementor;
class Libo_Blog_Post_Slider_Two_Widget extends Widget_Base
{
    ...
    {
        return esc_html__('Blog: Slider 02', 'libo-master');
    }
...
Plugin::instance()->widgets_manager->register_widget_type(new Libo_Blog_Post_Slider_Two_Widget());