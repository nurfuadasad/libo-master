...
namespace Elementor;
class Libo_Accordion_One extends Widget_Base {
    ...
    public function get_name() {
        return 'libo-accordion-one-widget';
    }
    ...
    public function get_title() {
        return esc_html__( 'Accordion 01', 'libo-master' );
    }
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
            'title', [
                ...
                'default'     => esc_html__( 'How to import my whole data?', 'libo-master' )
            ]
        );
        $repeater->add_control(
            'description', [
                ...
                'default'     => esc_html__( 'Duis aute irure dolor reprehenderit in voluptate velit essle cillum dolore eu fugiat nulla pariatur. Excepteur sint ocaec at cupdatat proident suntin culpa qui officia deserunt mol anim id esa laborum perspiciat.', 'libo-master' )
            ]
        );
        $this->add_control('accordion_items', [
            'label' => esc_html__('Accordion Item', 'libo-master'),
            'type' => Controls_Manager::REPEATER,
            'fields' => $repeater->get_controls(),
            'default' => [
                [
                    'title'        => esc_html__( 'How to import my whole data?', 'libo-master' ),
                    'description' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco lab oris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum.','libo-master'),
                ]
            ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Tab Settings', 'libo-master'),
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => __('Expanded Style', 'libo-master'),
            ]
        );
        ...
        $this->add_control('tab_paragraph_color', [
           ...
           $this->add_control('tab_border_color', [
            'type' => Controls_Manager::COLOR,
            'label' => esc_html__('Body Border Color', 'libo-master'),
            'selectors' => [
                "{{WRAPPER}} .accordion-wrapper .card .card-body" => "border-top-color: {{VALUE}}",
            ]
        ]);
...
Plugin::instance()->widgets_manager->register_widget_type( new Libo_Accordion_One() );