...
namespace Elementor;
class Libo_Portfolio_Grid_Item_Widget extends Widget_Base
{
    ...
    {
        return 'libo-portfolio-grid-widget';
    }
    ...
    {
        return esc_html__('Portfolio Grid: 01', 'libo-master');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control('normal_post_title_color', [
            ...
            'selectors' => [
                "{{WRAPPER}} .portfolio-single-item .hover-content .content-wrap .title" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('normal_post_paragraph_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .portfolio-single-item .hover-content .content-wrap ul li" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('background_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .portfolio-single-item .hover-content:after" => "background-color: {{VALUE}}"
            ]
        ]);
        ...
        $this->add_control('hover_post_title_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .portfolio-single-item .hover-content .content-wrap .title:hover" => "color: {{VALUE}}"
            ]
        ]);
        ...
        $this->add_group_control(Group_Control_Typography::get_type(), [
            ...
            'selector' => "{{WRAPPER}} .portfolio-single-item .hover-content .content-wrap .title"
        ]);
        ...
        $this->add_group_control(Group_Control_Typography::get_type(), [
            ...
            'selector' => "{{WRAPPER}} .portfolio-single-item .hover-content .content-wrap ul li"
        ]);
        $this->end_controls_section();
            ...
            <div class="row">
                ...
                while ($post_data->have_posts()):$post_data->the_post();
                    ...
                    <div class="col-lg-<?php echo esc_attr($settings['column']); ?> col-md-6">
                        <div class="portfolio-single-item margin-bottom-30">
                            <div class="hover-content">
                                <div class="content-wrap">
                                    ...
                                    <?php endif; ?>
                                    <?php the_category(); ?>
                                    <h4 class="title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?>
                                            <span>.</span></a></h4>
                                </div>
                            </div>
                            <div class="thumb">
...
Plugin::instance()->widgets_manager->register_widget_type(new Libo_Portfolio_Grid_Item_Widget());