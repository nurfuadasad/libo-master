...
namespace Elementor;
class Libo_Service_Slider_Four_Widget extends Widget_Base
{
    ...
    {
        return 'libo-service-slider-four-widget';
    }
    ...
    {
        return esc_html__('Service: Item 04', 'libo-master');
    }
                                    ...
                                    <?php if (!empty($post_categories)): ?>
                                        <ul>
                                            <?php foreach ($post_categories as $cats) : ?>
                                                <li><?php echo esc_attr($cats->name) ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    <?php endif; ?>
...
Plugin::instance()->widgets_manager->register_widget_type(new Libo_Service_Slider_Four_Widget());