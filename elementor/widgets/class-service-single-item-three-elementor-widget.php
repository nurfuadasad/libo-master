...
namespace Elementor;
class Libo_Service_Slider_Three_Widget extends Widget_Base
{
    ...
    {
        return 'libo-service-slider-three-widget';
    }
    ...
    {
        return esc_html__('Service: Item 03', 'libo-master');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'box_shadow',
                'label' => esc_html__( 'Box Shadow', 'libo-master' ),
                'selector' => '{{WRAPPER}} .service-single-item-03',
            ]
        );
        $this->add_control('icon_color', [
            ...
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03 .icon" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('icon_bg_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03 .icon" => "background-color: {{VALUE}}"
            ]
        ]);
        $this->add_control('content_bg_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03 .content" => "background-color: {{VALUE}}"
            ]
        ]);
        $this->add_control('title_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03 .content .title" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('paragraph_typography', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03 .content p" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('read_bg_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03 .content .read-btn" => "color: {{VALUE}}"
            ]
        ]);       
        $this->add_control('read_bg_color_icon', [
            'label' => esc_html__('Read More Icon Color', 'libo-master'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03 .content .read-btn i" => "color: {{VALUE}}"
            ]
        ]); 
		...
		$this->add_control('border_hover_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03:hover" => "border-top-color: {{VALUE}}"
            ]
        ]);
        $this->add_control('icon_hover_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03:hover .icon" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('icon_hover_bg_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03:hover .icon" => "background-color: {{VALUE}}"
            ]
        ]);
        $this->add_control('content_hover_bg_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03:hover .content" => "background-color: {{VALUE}}"
            ]
        ]);
        $this->add_control('title_hover_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03:hover .content .title" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('paragraph_hover_typography', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03:hover .content p" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('read_hover_bg_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .service-single-item-03 .content .read-btn:hover" => "color: {{VALUE}}"
            ]
        ]);
        $this->end_controls_tab();
            ...
            <div class="row">
                ...
                while ($post_data->have_posts()):$post_data->the_post();
                    ...
                    <div class="col-lg-<?php echo esc_attr($settings['column']); ?> col-md-6">
                        <div class="service-single-item-03 margin-bottom-30">
                            ...
                            <div class="content">
                                ...
                                <a class="read-btn"
                                   href="<?php the_permalink(); ?>"><?php echo esc_html($settings['read-btn']) ?><i
                                            class="fas fa-arrow-right"></i></a>
                                <?php if (!empty($service_icon)) {
                                    printf(' <div class="hover-icon"><i class="%1s"></i></div>', esc_attr($service_icon));
                                } ?>
                            </div>
                        </div>
                    </div>
...
Plugin::instance()->widgets_manager->register_widget_type(new Libo_Service_Slider_Three_Widget());